...
public class GenerateArrays {
	...
	/* Function to generate and print all sorted arrays from alternate
	 * elements of 'A[i..m-1]' and B[j..n-1]. If flag is true, then current 
	 * element to be included is A otherwise it is B. 'len' is the index in
	 * output array C[]. We print output array each time before including a 
	 * character from A only if length of output array is greater than 0.
	 * We try then all possible combinations */
	...
	// The utility function to pront an array
